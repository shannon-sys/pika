...
//
// An Env is an interface used by the shannon implementation to access
...
class Env {
 public:
  ...
  //
  // The result of Default() belongs to shannon and must never be deleted.
  static Env* Default();
  /*{
      return new Env();
      //return NULL;
  ...
  // used in shannon internally to update thread status and supports
  // GetThreadList().
