...
//#include "shannon/memtablerep.h"
//#include "shannon/universal_compaction.h"
...
/*struct AdvancedColumnFamilyOptions {
  ...
  // In this case. (In this case, the snapshot-semantics of the shannon
  ...
  // If true, shannon will pick target size of each level dynamically.
  ...
  // In debug mode, shannon run consistency checks on the LSM every time the LSM
