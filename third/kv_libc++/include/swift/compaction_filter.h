...
#ifndef STORAGE_SHANNONDB_INCLUDE_COMPACTION_FILTER_H_
#define STORAGE_SHANNONDB_INCLUDE_COMPACTION_FILTER_H_
...
#endif  // STORAGE_SHANNONDB_INCLUDE_COMPACTION_FILTER_H_
