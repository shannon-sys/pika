...
class ListsMetaFilter : public shannon::CompactionFilter {
  public:
...
class ListsMetaFilterFactory : public shannon::CompactionFilterFactory {
  public:
    ...
    virtual std::unique_ptr<shannon::CompactionFilter> CreateCompactionFilter(
      ...
      return std::unique_ptr<shannon::CompactionFilter>(new ListsMetaFilter());
    }
...
class ListsDataFilter : public shannon::CompactionFilter {
  public:
    ListsDataFilter(shannon::DB* db,
...
class ListsDataFilterFactory : public shannon::CompactionFilterFactory {
  public:
    ListsDataFilterFactory(shannon::DB** db_ptr,
