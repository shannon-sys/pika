...
ifndef SHANNONDB_PATH
  $(warning Warning: missing shannon path, using default)
  SHANNONDB_PATH=$(DEPS_DIR)/kv_libc++
endif
SHANNONDB_INCLUDE_DIR=$(SHANNONDB_PATH)/include
SHANNONDB_LIBRARY=$(SHANNONDB_PATH)/libshannondb_cxx.a
...
CXXFLAGS += $(WARNING_FLAGS) -I. -I./include -I$(SLASH_INCLUDE_DIR) -I$(SHANNONDB_PATH) -I$(SHANNONDB_INCLUDE_DIR) $(OPT)
date := $(shell date +%F)
